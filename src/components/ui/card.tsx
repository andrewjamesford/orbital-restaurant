...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "backdrop-blur-xl bg-cosmos-900/30 border border-white/10 rounded-2xl transition-all duration-500",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-white/60 font-body text-sm leading-relaxed", className)}
    {...props}
  />
));
